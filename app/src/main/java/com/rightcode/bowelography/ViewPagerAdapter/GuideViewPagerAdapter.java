...
import com.rightcode.bowelography.activity.IntroActivity;
...
public class GuideViewPagerAdapter extends RecyclerView.Adapter<GuideViewPagerAdapter.ViewHolder> {
    ...
    public GuideViewPagerAdapter(Context mContext, ArrayList<Integer> images) {
    ...
    public class ViewHolder extends CommonViewHolder<ItemGuideViewpagerBinding, Integer> {
        ...
        public void onBind(Integer item) {
            ...
            position_now++;
            System.out.println(position_now);
        }
    }
}
